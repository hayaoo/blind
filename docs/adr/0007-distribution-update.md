...
| セクション | 内容 |
|-----------|------|
| How it works | 3ステップ図解（通知→目を閉じる→気づき） |
| Features | 無料版/Pro版の比較表 |
| Privacy | 「カメラ映像は保存・送信しません」を目立つ位置に |
| FAQ | よくある質問3-5個 |
| Footer | GitHub / Privacy Policy / @hayaoo |
...
## Pro
$14の買い切りで追加機能をアンロック（Pre-close/Post-closeトレーニング、週次レポート等）
